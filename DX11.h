...
namespace DX11
{
	...
	namespace ImGui_DX11
	{
		...
		namespace Color
		{
			...
			const ImColor BackgroundText = ImColor(64, 64, 64, 255);
			...
			const ImColor BotColor = ImColor(0, 255, 255);


			const ImColor Smoke = ImColor(255, 225, 194);
			const ImColor Molotof = ImColor(255, 0, 0);
			const ImColor Burn = ImColor(255, 0, 0);
			const ImColor Grenade = ImColor(255, 0, 0);

			const ImColor EnergyDrink = ImColor(255, 0, 255);
			const ImColor Painkiller = ImColor(255, 0, 255);
			const ImColor Firstkit = ImColor(255, 0, 255);
			const ImColor Madkit = ImColor(255, 0, 255);
			const ImColor AdrenalineSyringe = ImColor(255, 0, 255);

			const ImColor ammo5_56mm = ImColor(69, 245, 74);
			const ImColor ammo7_62mm = ImColor(255, 211, 140);
			const ImColor ammo9mm = ImColor(255, 253, 227);
			const ImColor ammo45ACP = ImColor(255, 253, 227);

			const ImColor weapon5mm = ImColor(255, 255, 0, 255);
			const ImColor weapon7mm = ImColor(255, 255, 0, 255);

			const ImColor scope2x = ImColor(82, 194, 255);
			const ImColor scope3x = ImColor(82, 194, 255);
			const ImColor scope4x = ImColor(82, 194, 255);
			const ImColor scope6x = ImColor(247, 69, 117);
			const ImColor scope8x = ImColor(247, 69, 117);
